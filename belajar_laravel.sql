...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Sep 2021 pada 04.24
...
(18, 12355, '2021-09-28', '2021-10-03');
...
--
ALTER TABLE `detail_peminjaman_buku`
  MODIFY `id_detail_peminjaman_buku` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `peminjaman_buku`
  MODIFY `id_peminjaman_buku` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `pengembalian_buku`
--
ALTER TABLE `pengembalian_buku`
  MODIFY `id_pengembalian_buku` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
